<%-- 
    Document   : refund
    Created on : 2019-11-29, 15:22:31
    Author     : 滕
--%>
...
//                        genIp ip = new genIp();
                        ...
                        //genLog.Log(u.getUser_id(), InetAddress.getLocalHost().getHostAddress(), "16", coo[0].getName(), coo[1].getName(), "", "");
