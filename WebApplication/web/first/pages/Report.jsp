<%-- 
    Document   : Report
    Created on : 2019-11-29, 15:28:30
    Author     : 滕
--%>
...
//                        genIp ip = new genIp();
                        ...
                        //genLog.Log(u.getUser_id(), InetAddress.getLocalHost().getHostAddress(), "17", coo[0].getName(), coo[1].getName(), "", "");
...
//                        out.println(u.toString());
        ...
        <div class="rightCol">
            ...
            <!--<div class="label">-->
            <div class="good">Reported shop owner</div>
            <div class="single">resaon</div>
