...
public class Mostpopularitem {
    ...
    static class MapDistinctTask extends Mapper<LongWritable, Text, Text, Text> {
        ...
        protected void map(LongWritable key, Text value, Context context)
            ...
            if("pv".equals(ss[3])) { // click
                context.write(new Text("pv"), new Text(ss[1]));
            }
        }
    }
    ...
    static class ReduceDistinctTask extends Reducer<Text, Text, Text, Text> {
        ...
        protected void reduce(Text key, Iterable<Text> values, Context context)
            ...
            while (it1.hasNext()) {
                ...
                context.write(new Text(vv), new Text(Integer.toString(kk)));
            }
        }
    }
    ...
    public static void main(String[] args) throws IOException, InterruptedException, ClassNotFoundException {
        ...
        job.setJobName("Mostpopularitem");
        job.setJarByClass(Mostpopularitem.class);
